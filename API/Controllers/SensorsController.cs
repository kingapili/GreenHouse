...
namespace API.Controllers
{
    ...
    public class SensorsController
    {
        ...
        public ActionResult<List<SensorData>> GetSensorData([FromQuery]int? sensorId, [FromQuery]string sensorType,
            [FromQuery]DateTime? startDateTime,[FromQuery]DateTime? endDateTime, [FromQuery]double? value, [FromQuery]int? page,[FromQuery] int? pageSize,
            [FromQuery]string sortBy, [FromQuery]bool? ascending)
        {
            return _service.GetAll(sensorId, sensorType, startDateTime, endDateTime, value, page, pageSize, sortBy, ascending);
        }
